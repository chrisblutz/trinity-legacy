...
class NativeMath {
    ...
    static void register() {
        ...
        TrinityNatives.registerMethod("Trinity.Math", "abs", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
            
            double x = TrinityNatives.toFloat(runtime.getVariable("x"));
            
            return TrinityNatives.wrapNumber(Math.abs(x));
        });
        TrinityNatives.registerMethod("Trinity.Math", "sqrt", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
        ...
        TrinityNatives.registerMethod("Trinity.Math", "sin", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.sin(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "cos", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.cos(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "tan", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.tan(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "arcsin", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.asin(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "arccos", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.acos(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "arctan", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.atan(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "toDegrees", true, new String[]{"rad"}, null, null, null, (runtime, thisObj, params) -> {
            
            double rad = TrinityNatives.toFloat(runtime.getVariable("rad"));
            
            return TrinityNatives.wrapNumber(Math.toDegrees(rad));
        });
        TrinityNatives.registerMethod("Trinity.Math", "toRadians", true, new String[]{"deg"}, null, null, null, (runtime, thisObj, params) -> {
        ...
        TrinityNatives.registerMethod("Trinity.Math", "log", true, new String[]{"x"}, optionalParams, null, null, (runtime, thisObj, params) -> {
        ...
        TrinityNatives.registerMethod("Trinity.Math", "ln", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
            
            double x = TrinityNatives.toFloat(runtime.getVariable("x"));
            
            return TrinityNatives.wrapNumber(Math.log(x));
        });
        TrinityNatives.registerMethod("Trinity.Math", "round", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
            
            double x = TrinityNatives.toFloat(runtime.getVariable("x"));
            
            return TrinityNatives.wrapNumber(Math.round(x));
        });
        TrinityNatives.registerMethod("Trinity.Math", "ceil", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
            
            double x = TrinityNatives.toFloat(runtime.getVariable("x"));
            
            return TrinityNatives.wrapNumber(Math.ceil(x));
        });
        TrinityNatives.registerMethod("Trinity.Math", "floor", true, new String[]{"x"}, null, null, null, (runtime, thisObj, params) -> {
